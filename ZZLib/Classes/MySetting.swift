...
public class MySetting: NSObject,MFMailComposeViewControllerDelegate {
    ...
    fileprivate func contactWithWeixin() {
        ...
        let av = UIAlertController(title: localizedString("Notice"), message: localizedString("Add hellobanny in weixin and start a chat. The user name has add to your paste board."), preferredStyle: .alert)
